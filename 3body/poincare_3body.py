...
def f(x):
    ...
    return torch.transpose(torch.stack([xx1_dot, yy1_dot, xx2_dot, yy2_dot, xx3_dot, yy3_dot,
                                        vx1_dot, vy1_dot, vx2_dot, vy2_dot, vx3_dot, vy3_dot,]),0,1)
...
plt.yscale('log')
plt.title('AI Poincare Three body')
